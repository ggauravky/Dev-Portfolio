                ...
                <div className="relative max-w-6xl w-full flex flex-col md:flex-row items-center justify-between gap-12 md:gap-20 z-10">
                    ...
                    <div className="flex-1 flex justify-center animate-float">
                        <div className="relative group">
                            <div className="absolute inset-0 bg-gradient-to-r from-blue-500 via-purple-500 to-cyan-500 rounded-full blur-3xl opacity-40 group-hover:opacity-60 transition-opacity duration-500 animate-pulse"></div>
                            ...
                            <img
                                ...
                                className="relative w-64 h-64 md:w-96 md:h-96 rounded-full object-cover border-4 border-blue-500/30 shadow-2xl group-hover:scale-105 transition-transform duration-500 ring-4 ring-blue-500/20 ring-offset-4 ring-offset-slate-900"
                            />
                        </div>
                    </div>
                </div>
