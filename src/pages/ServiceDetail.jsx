...
function ServiceDetail({ forcedSlug = '' }) {
    ...
    useSEO({
        ...
        description: `${service.summary} Pricing: ${service.priceLabel}. Secure booking with Razorpay.`,
        keywords: `${service.title}, developer service, ${service.category}, secure booking, Razorpay`,
                ...
                <section className="rounded-3xl border border-slate-700/70 bg-gradient-to-br from-slate-800/70 via-slate-900/80 to-slate-900/90 p-6 sm:p-8 lg:p-10 mb-8 sm:mb-10">
                    ...
                    <div className="grid lg:grid-cols-3 gap-6 lg:gap-8 items-start">
                        ...
                        <div className="rounded-2xl border border-cyan-500/20 bg-slate-900/60 p-5 sm:p-6">
                            ...
                            <p className="text-xs text-slate-400 mt-3">100% secure checkout through Razorpay. No card data stored on this website.</p>
