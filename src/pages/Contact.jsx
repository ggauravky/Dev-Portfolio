...
function Contact() {
    ...
    const handleSubmit = (e) => {
        ...
        alert('Message sent! 🎉 (Backend will be integrated soon)')
                    ...
                    <div className="animate-slideRight">
                        <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-8 hover:border-purple-500/50 transition-all duration-300">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div>
                                    <label htmlFor="name" className="block text-slate-300 font-medium mb-2 flex items-center gap-2">
                                        <span>👤</span> Your Name
                                    </label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <label htmlFor="email" className="block text-slate-300 font-medium mb-2 flex items-center gap-2">
                                ...
                                <div>
                                    <label htmlFor="message" className="block text-slate-300 font-medium mb-2 flex items-center gap-2">
                                ...
                                <button
                                    type="submit"
                                    className="w-full bg-gradient-to-r from-cyan-600 via-blue-600 to-purple-600 hover:from-cyan-500 hover:via-blue-500 hover:to-purple-500 text-white font-semibold py-4 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/50 flex items-center justify-center gap-3 group"
                                >
