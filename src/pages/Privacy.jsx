            ...
            <div className="max-w-4xl mx-auto relative z-10">
                ...
                <div className="text-center mb-12">
                    <h1 className="text-4xl sm:text-5xl md:text-6xl font-display font-black mb-4 uppercase tracking-tight text-white">
                        Privacy <span className="bg-gradient-to-r from-toxic via-white to-cyber bg-clip-text text-transparent">Policy</span>
                    </h1>
                ...
                <div className="legal-content bg-[#0e0e11] border border-[#1a1a22] p-6 sm:p-10 rounded-lg space-y-8 relative overflow-hidden">
                    ...
                    <section className="space-y-3 sm:space-y-4">
                        ...
                        <p className="text-[#a1a1aa] text-sm sm:text-base leading-relaxed">
                            ...
                            <span className="text-white font-semibold">ggauravky.vercel.app</span>.
                        </p>
                    </section>
                    ...
                    <section className="space-y-4">
                        ...
                        <div className="space-y-3">
                            <h3 className="text-base sm:text-lg font-semibold text-white">Information You Provide:</h3>
                            ...
                            <h3 className="text-base sm:text-lg font-semibold text-white mt-6">Automatically Collected Information:</h3>
                            <ul className="space-y-2 ml-2 sm:ml-4">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-2">
                            <svg className="w-6 h-6 text-cyber" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 21l8.982-11.795H13.43l1.562-6.52L6 14.518h5.373L9.813 15.904z" /></svg>
                            <span>AI Feature Data Handling</span>
                        </h2>
                    ...
                    <section className="space-y-4">
                        ...
                        <ul className="space-y-2 ml-4">
                            <li><strong>Vercel:</strong> Website hosting (read their <a href="https://vercel.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer">Privacy Policy</a>)</li>
                            <li><strong>Google Analytics:</strong> Website analytics (read their <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">Privacy Policy</a>)</li>
                            <li><strong>MongoDB Atlas:</strong> Database storage (read their <a href="https://www.mongodb.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer">Privacy Policy</a>)</li>
                            <li><strong>Cloudinary:</strong> Secure image storage and delivery for AI image uploads (read their <a href="https://cloudinary.com/privacy" target="_blank" rel="noopener noreferrer">Privacy Policy</a>)</li>
                        </ul>
                    </section>

                    <section className="space-y-4">
                        <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-2">
                            <svg className="w-6 h-6 text-cyber" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg> Your Rights
                        </h2>
                        <p className="leading-relaxed">
                        ...
                        <p className="leading-relaxed mt-6">
                            ...
                            <a href="mailto:kumar.gaurav.yadav2007@gmail.com" className="font-semibold">
